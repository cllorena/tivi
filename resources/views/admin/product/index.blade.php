                  ...
                  <tbody>
                   ...
                   @foreach($productos as $producto)
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-default" href="{{ route('admin.product.show',$producto->slug) }}"><i class="fas fa-eye"></i></a>
                      </td>
                      ...
                      <td><a class="btn btn-danger" href="{{ route('admin.product.index') }}" 
                              v-on:click.prevent="deseas_eliminar({{ $producto->id }})">Eliminarr</a>
                      </td>
