                  ...
                  <tbody>
                   ...
                   @foreach($categorias as $categoria)
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-default" href="{{ route('admin.category.show',$categoria->slug) }}"><i class="fas fa-eye"></i></a>
                      </td>
                      ...
                      <td><a class="btn btn-danger" href="{{ route('admin.category.index') }}" 
                              v-on:click.prevent="deseas_eliminar({{ $categoria->id }})">Eliminarr</a>
                      </td>
