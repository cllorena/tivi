...
class AdminCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        //Esto tambien funciona
            //$nombre = 'nombre';
            //$categorias = Category::orderBy('nombre','DESC')->paginate(2);
        //Fin esto tambien funciona
        ...
        ->select('id','nombre','slug','descripcion','created_at','updated_at')
        ...
        /*$categorias = DB::table('categories')->paginate(2);
    ...
    public function store(Request $request)
    {
        ...
        /* Primera Forma de guardar los datos
        $cat = new Category;
        ...
        */
        ...
        /* Segunda Forma de guardar los datos ( Los campos se definen en en el modelo Category.php )*/
    ...
    public function update(Request $request, $id)
    {
        ...
        /* Primera forma igual que en store
        $cat->nombre            = $request->nombre;
        $cat->slug              = $request->slug;
        $cat->descripcion       = $request->descripcion;
        $cat->save();
